  ...
  return (
    ...
    <div className="min-h-screen  px-6 md:px-32 2xl:px-32 py-12 p-4 flex justify-center items-center">
     <div className='w-full md:flex md:font-semibold'>
        ...
        <div className='bg-primaryColor *:rounded-full *:h-12 *:w-12 relative'>
          {/* Overlay effect */}
          ...
          {/* {[4,20].map((value,index)=>{
            ...
            <h1 className='relative z-10 text-6xl md:text-7xl mb-8 py-4 text-center text-white'>Checkout</h1>
          </div>

          <h3 className='text-xl mt-12 text-gray-600'>Proceed to pay</h3>
          <p className='text-4xl text-gray-600 font-semibold'>5000</p>
              ...
              {payments.map((method, index) => (
                <button
                  ...
                  className={`
                    ...
                    font-medium flex w-full items-center text-gray-600 justify-between p-3 bg-white border rounded-lg
                  `}>
